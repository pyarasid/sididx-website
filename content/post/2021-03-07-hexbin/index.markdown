...
We will use "geogrid" package in R to algorithmically tessellate kenya's map into hexagonal grids. You can find more information its [github repository](https://github.com/jbaileyh/geogrid).
